...
$ helm install cert-manager --namespace cert-manager --version v1.15.5 jetstack/cert-manager
```
...
```console
$ kubectl delete -f https://github.com/cert-manager/cert-manager/releases/download/v1.15.5/cert-manager.crds.yaml
```
